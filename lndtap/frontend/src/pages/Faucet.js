    ...
    return (
      <div>
        <Jumbotron style={{ padding: 20 }}>
          <h1>LndTap</h1>
          <p className="lead">
            Faucet for Bitcoin Tesnet on Lightening Network
          </p>
          <hr className="my-2" />
          <p>Peer Address</p>
          <p className="lead">
        ...
        <div style={styles.formContainer}>
          <p className="text-center">
            {" "}
            Enter following details to create a new channel with the faucet and
          ...
          <Form>
            ...
            <FormGroup>
              ...
              <Input
                ...
                name="publicKey"
                id="publicKey"
                placeholder="Enter Target Node Public Key"
                onChange={e => this.onChange("pubkey", e.target.value)}
              />
            </FormGroup>
            <FormGroup>
              ...
              <Input
                ...
                name="channelAmount"
                id="channelAmount"
                placeholder="Max is 16 million"
                onChange={e =>
                  this.onChange("channel_amount", parseInt(e.target.value))
                }
              />
            </FormGroup>
            <FormGroup>
              ...
              <Input
                ...
                name="initialBalance"
                id="initialBalance"
                placeholder="Total amount to be sent initially"
                onChange={e =>
                  this.onChange("initial_balance", parseInt(e.target.value))
                }
              />
            </FormGroup>
            <Button
